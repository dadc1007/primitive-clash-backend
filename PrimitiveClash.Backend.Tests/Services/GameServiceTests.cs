...
//         var playerState1 = new PlayerState(user1Id, "User1", new List<PlayerCard>());
//         var playerState2 = new PlayerState(user2Id, "User2", new List<PlayerCard>());
...
//         {
//             new PlayerState(user1Id, "User1", new List<PlayerCard>()),
//             new PlayerState(user2Id, "User2", new List<PlayerCard>())
//         };
...
//         var playerStates = new List<PlayerState>
//         {
//             new PlayerState(winnerId, "Winner", new List<PlayerCard>()),
//             new PlayerState(loserId, "Loser", new List<PlayerCard>())
//         };
//         var arena = CreateTestArena();
...
//         // Arrange
//         var userId = Guid.NewGuid();
//         var playerState = new PlayerState(userId, "User1", new List<PlayerCard>());
//         var game = new Game(
//             Guid.NewGuid(),
...
//         var connectionId = "test-connection";
//         var playerState = new PlayerState(existingUserId, "User1", new List<PlayerCard>())
//         {
//             IsConnected = false,
//             ConnectionId = null
//         };
